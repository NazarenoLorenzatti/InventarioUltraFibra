...
public class Frm_AgregarComentario extends javax.swing.JInternalFrame {

    private Cls_ComentarioEntrada CE;

    public Frm_AgregarComentario() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese el Comentario");
    ...
    private void jBtnAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBtnAgregarMouseClicked
        ...
        if (!comentario.equals("") || !comentario.equals(" ")) {
            ...
            this.CE.registrarComentario(comentario);
            Frm_Entrada.jComboBoxComentarios.setModel(CE.setComboBox());
