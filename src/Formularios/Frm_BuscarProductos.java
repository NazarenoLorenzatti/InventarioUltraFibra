...
// formulario para buscar productos por nombre o codigo.
...
public class Frm_BuscarProductos extends javax.swing.JInternalFrame {
    ...
    // Cada vez que se actualiza el textfield realiza la busqueda
    ...
    //metodo para caputar lo que se seleccion en el Jtable
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        if(Frm_Entrada.enviar == 1){
            ...
            Frm_Entrada.txt_codigo.requestFocus();
            ...
            Frm_Salida.txt_codigo.requestFocus();
            Frm_Salida.enviar = 0;
            dispose();
        }
